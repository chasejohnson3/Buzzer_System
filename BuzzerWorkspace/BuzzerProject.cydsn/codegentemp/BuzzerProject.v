...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("608d52e2-0db5-4276-b589-6c2658941916/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("aacaa8e8-44db-4af9-b411-3c225739cea2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 LEDdoc (
        .connect({
            Net_38,
            Net_40
        })
    );
    defparam LEDdoc.comp_name = "LED_v1_0";
    defparam LEDdoc.port_names = "A, K";
    defparam LEDdoc.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("76703f01-2d47-46f5-9ec1-e11f7ed98f2d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1c9527af-d5d8-4e99-ba10-67780ac29883"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 LEDdoc_1 (
        .connect({
            Net_45,
            Net_46
        })
    );
    defparam LEDdoc_1.comp_name = "LED_v1_0";
    defparam LEDdoc_1.port_names = "A, K";
    defparam LEDdoc_1.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("7063884e-41f8-452f-9047-5fc3aada78b9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("caeeedef-e265-4cef-a649-87cf39a9bf5e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 LEDdoc_2 (
        .connect({
            Net_50,
            Net_51
        })
    );
    defparam LEDdoc_2.comp_name = "LED_v1_0";
    defparam LEDdoc_2.port_names = "A, K";
    defparam LEDdoc_2.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("0c6b71e3-636c-4503-bd33-01e26a3a0b2d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e31207f0-a206-428a-90e1-fc7b5bb376ce"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 LEDdoc_3 (
        .connect({
            Net_55,
            Net_56
        })
    );
    defparam LEDdoc_3.comp_name = "LED_v1_0";
    defparam LEDdoc_3.port_names = "A, K";
    defparam LEDdoc_3.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("4d9b48e6-f878-46c1-b692-92a2c8b36b73"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("af5dba23-1066-4c65-bfed-317b76349c50"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 LEDdoc_4 (
        .connect({
            Net_61,
            Net_62
        })
    );
    defparam LEDdoc_4.comp_name = "LED_v1_0";
    defparam LEDdoc_4.port_names = "A, K";
    defparam LEDdoc_4.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("931e5718-60d5-4cb5-9f0f-400bdbadd218"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 LEDdoc_5 (
        .connect({
            Net_64,
            Net_65
        })
    );
    defparam LEDdoc_5.comp_name = "LED_v1_0";
    defparam LEDdoc_5.port_names = "A, K";
    defparam LEDdoc_5.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("29e02e78-ceac-432d-a4cb-f72b8b74c36d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 LEDdoc_6 (
        .connect({
            Net_68,
            Net_69
        })
    );
    defparam LEDdoc_6.comp_name = "LED_v1_0";
    defparam LEDdoc_6.port_names = "A, K";
    defparam LEDdoc_6.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("63789eff-76f2-4349-9138-7118b8449ea4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Button_6_net;
	wire [0:0] tmpFB_0__Button_6_net;
	wire [0:0] tmpIO_0__Button_6_net;
	wire [0:0] tmpINTERRUPT_0__Button_6_net;
	electrical [0:0] tmpSIOVREF__Button_6_net;

	cy_psoc3_pins_v1_10
		#(.id("d069787b-7261-4a2c-aaff-2694377e1e94"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button_6
		 (.oe(tmpOE__Button_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_6_net[0:0]}),
		  .io({tmpIO_0__Button_6_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_6_net),
		  .interrupt({tmpINTERRUPT_0__Button_6_net[0:0]}),
		  .annotation({Net_72}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Button_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 LEDdoc_7 (
        .connect({
            Net_73,
            Net_74
        })
    );
    defparam LEDdoc_7.comp_name = "LED_v1_0";
    defparam LEDdoc_7.port_names = "A, K";
    defparam LEDdoc_7.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("75fcb4be-8f06-401f-9693-937f50c8a061"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Button_7_net;
	wire [0:0] tmpFB_0__Button_7_net;
	wire [0:0] tmpIO_0__Button_7_net;
	wire [0:0] tmpINTERRUPT_0__Button_7_net;
	electrical [0:0] tmpSIOVREF__Button_7_net;

	cy_psoc3_pins_v1_10
		#(.id("31f16b4f-2774-4d86-87d6-28e940860554"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button_7
		 (.oe(tmpOE__Button_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_7_net[0:0]}),
		  .io({tmpIO_0__Button_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_7_net),
		  .interrupt({tmpINTERRUPT_0__Button_7_net[0:0]}),
		  .annotation({Net_77}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Button_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 LEDdoc_8 (
        .connect({
            Net_78,
            Net_79
        })
    );
    defparam LEDdoc_8.comp_name = "LED_v1_0";
    defparam LEDdoc_8.port_names = "A, K";
    defparam LEDdoc_8.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("ebee3544-bb2a-41f8-82e3-deb3e3762f2d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Button_8_net;
	wire [0:0] tmpFB_0__Button_8_net;
	wire [0:0] tmpIO_0__Button_8_net;
	wire [0:0] tmpINTERRUPT_0__Button_8_net;
	electrical [0:0] tmpSIOVREF__Button_8_net;

	cy_psoc3_pins_v1_10
		#(.id("bcb532c0-3e90-446b-9829-47389a1deb13"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button_8
		 (.oe(tmpOE__Button_8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_8_net[0:0]}),
		  .io({tmpIO_0__Button_8_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_8_net),
		  .interrupt({tmpINTERRUPT_0__Button_8_net[0:0]}),
		  .annotation({Net_82}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Button_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 LEDdoc_9 (
        .connect({
            Net_83,
            Net_84
        })
    );
    defparam LEDdoc_9.comp_name = "LED_v1_0";
    defparam LEDdoc_9.port_names = "A, K";
    defparam LEDdoc_9.width = 2;
