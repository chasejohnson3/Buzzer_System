// ======================================================================
// Input_Test.v generated from TopDesign.cysch
// 01/02/2018 at 15:19
...
module top ;
    ...
    cy_annotation_universal_v1_0 LEDseen (
        .connect({
            Net_3,
            Net_6
        })
    );
    defparam LEDseen.comp_name = "LED_v1_0";
    defparam LEDseen.port_names = "A, K";
    defparam LEDseen.width = 2;
